...
- Store sensitive information in a secure manner, such as using HashiCorp Vault.
  - Regularly rotate credentials and secrets.
  - Automate the rotation of secrets, where possible.
- Use Terraform environment variables (TF_VAR prefixed variables) to reference values stored in HashiCorp Vault.
